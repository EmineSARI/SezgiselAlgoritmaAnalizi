...
CostFunction=@(m) ClusteringCost(m, X);     % Cost Fonksiyonu

VarSize=[k size(X,2)];  % özellik sayýsý(stun)
nVar=prod(VarSize);     % Karar Deðiþkenlerinin Sayýsý
...
MaxIt=200;      % Max iterasyon 

nPop=50;        % Populasyon sayýsý
